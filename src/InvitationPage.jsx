...
function OrnDivider() {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "0 32px", background: "#fff" }}>
      <div style={{ flex: 1, height: 0.5, background: "rgba(201,168,76,0.3)" }} />
      <div style={{ width: 6, height: 6, background: "#c9a84c", transform: "rotate(45deg)", opacity: 0.6, flexShrink: 0 }} />
      <div style={{ flex: 1, height: 0.5, background: "rgba(201,168,76,0.3)" }} />
    </div>
  );
}
      ...
      {blocks.map((b, i) => (
        <div key={b.label} style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", minWidth: 64 }}>
            <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 42, color: "#2a1a08", fontWeight: 400, lineHeight: 1 }}>
              {b.val}
            </div>
          ...
          {i < blocks.length - 1 && (
            <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 32, color: "#c9a84c", paddingTop: 4 }}>·</div>
          )}
        </div>
      ))}
    </div>
...
function GardenIllustration() {
  return (
    <svg style={{ width: "100%", display: "block" }} viewBox="0 0 360 200" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="105" y="90" width="150" height="75" rx="1" fill="#f0e8d8" stroke="#c9a84c" strokeWidth="0.8" />
      <rect x="113" y="90" width="9" height="75" fill="#e0d0b0" stroke="#b8943c" strokeWidth="0.4" />
      <rect x="238" y="90" width="9" height="75" fill="#e0d0b0" stroke="#b8943c" strokeWidth="0.4" />
      <rect x="150" y="90" width="7" height="75" fill="#e8dcc0" opacity="0.6" />
      <rect x="203" y="90" width="7" height="75" fill="#e8dcc0" opacity="0.6" />
      <polygon points="93,90 267,90 180,58" fill="#e8dcc0" stroke="#c9a84c" strokeWidth="0.8" />
      <rect x="158" y="133" width="44" height="32" rx="22" fill="#fff" stroke="#c9a84c" strokeWidth="0.5" />
      <rect x="120" y="102" width="24" height="18" rx="2" fill="#fffbe6" stroke="#c9a84c" strokeWidth="0.4" opacity="0.9" />
      <rect x="216" y="102" width="24" height="18" rx="2" fill="#fffbe6" stroke="#c9a84c" strokeWidth="0.4" opacity="0.9" />
      <path d="M60,82 Q110,66 150,76 Q180,68 210,76 Q250,66 300,82" fill="none" stroke="#c9a84c" strokeWidth="0.6" opacity="0.7" />
      {[74, 110, 150, 180, 210, 250, 286].map((cx, i) => (
        <circle key={i} cx={cx} cy={[79, 70, 75, 69, 75, 69, 79][i]} r="2.8" fill="#c9a84c" opacity="0.8" />
      ))}
      ...
      <path d="M160,175 Q180,165 200,175 L204,195 Q180,186 156,195 Z" fill="#e0d4b0" />
      <text x="180" y="85" textAnchor="middle" fontFamily="'Great Vibes', cursive" fontSize="9" fill="#c9a84c">
        Raustic Garden
      </text>
    </svg>
  );
...
export default function InvitationPage() {
  ...
  return (
    <div style={{ width: "100%", background: "#fff", fontFamily: "'Cormorant Garamond', serif", overflowX: "hidden" }}>
      ...
      <div style={{ width: "100%", maxWidth: 520, margin: "0 auto", background: "#fff", paddingBottom: 60 }}>
        ...
        <Section id="date-section">
          ...
          <div style={s.dateNote}>
            We kindly invite you to join us early<br />
        ...
        <Section id="venue-section">
          ...
          <div style={s.venueName}>Raustic Garden Venue</div>
          <div style={s.venueAddr}>Cairo, Egypt</div>
          <div style={s.mapFrame}>
            <iframe
              title="Raustic Garden Venue"
        ...
        <Section id="rsvp-section">
          ...
          <div style={s.rsvpSub}>Kindly confirm your attendance by reaching out to us</div>
        ...
        <Section id="message-section">
          ...
          <div style={s.messageBody}>
            ...
            celebrating surrounded by all of you.<br /><br />
            ...
            becomes a memory you carry with you just as tenderly as we will.<br /><br />
          ...
          <div style={s.messageSig}>
            With all our love,<br />Abdallah &amp; Sohaila
          </div>
        ...
        >
          <div style={s.monogram}>A &amp; S</div>
          <div style={{ fontSize: 11, letterSpacing: 4, color: "#c9a84c", opacity: 0.6, textTransform: "uppercase", marginTop: 4, fontFamily: "'Cormorant Garamond', serif" }}>
            12 · 06 · 2026
          </div>
        </div>
